	...
	for (var _enemy_index = 0; _enemy_index < array_length(enemy_infos); _enemy_index++) {
		...
		switch (_enemy.type) {
			...
			case 1:
				...
				_enemy_instance.phy_speed_x = lengthdir_x(_enemy_speed, _lowest_direction) / game_speed * 60;
				_enemy_instance.phy_speed_y = lengthdir_y(_enemy_speed, _lowest_direction) / game_speed * 60;
				_enemy.speed_x = lengthdir_x(_enemy_speed, _lowest_direction);
				_enemy.speed_y = lengthdir_y(_enemy_speed, _lowest_direction);
			break;
			case 2:
				var _enemy_speed = 6;
				//var _dist_to_stop = 150; 		
