...
function handle_shooting(_x, _y, _angle, _ghost, _owner) {
	var _new_id = -1;
	...
	array_push(bullet_infos, {this_id: _new_id, x_pos: _x, y_pos: _y, angle: _angle, despawn_timer: _despawn_time, ghost: _ghost, owner: _owner});
